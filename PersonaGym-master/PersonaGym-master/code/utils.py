...
def openai_chat_gen(input_prompt = None,
    ...
    while max_attempt > 0:
        try:
            ...
            # GPT-5 family expects max_completion_tokens on Chat Completions and
            # currently supports only default sampling settings in this workflow.
            if model_card.startswith("gpt-5"):
                request_kwargs["max_completion_tokens"] = max_tokens
                if system and not message:
                    request_kwargs["messages"] = message
            else:
