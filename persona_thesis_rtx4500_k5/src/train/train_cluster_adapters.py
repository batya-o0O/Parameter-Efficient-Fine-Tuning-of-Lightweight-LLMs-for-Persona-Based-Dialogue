...
def main():
    ...
    ap.add_argument("--output_root", default="outputs/phase2_clusters_k5")
    ...
    ap.add_argument(
        ...
        type=str,
        default="",
        help="Comma-separated cluster ids to train (default: all clusters). Example: 0,3,4",
    )
    ...
    for cluster_id in cluster_ids:
        ...
        roles = [m["persona_id"] for m in members]
